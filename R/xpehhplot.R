# function (xpehh.data, file.name file.type = 'png', plot.pval = TRUE, ylim.scan = 2, pch = 16, cex = 0.5, 
...
#     
#     if(file.type == 'png') {
#       file.name <- ifelse(substrRight(file.name, 4L) == ".png", paste0(file.name, ".ihsplot"), paste0(file.name, ".rsbplot.uni.score.png"))
#       png(file.name, width = 800, height = 600, pointsize = 16)
#     }
#     
#     if(file.type == 'svg') {
#       file.name <- ifelse(substrRight(file.name, 4L) == ".svg", paste0(file.name, ".ihsplot"), paste0(file.name, ".rsbplot.uni.score.svg"))
#       svg(file.name, width = 800, height = 600, pointsize = 16)
#     }
#     
#     if(file.type == 'pdf') {
#       file.name <- ifelse(substrRight(file.name, 4L) == ".pdf", paste0(file.name, ".ihsplot"), paste0(file.name, ".rsbplot.uni.score.pdf"))
#       pdf(file.name, width = 800, height = 600, pointsize = 16)
#     }
#     
...
#     par(mar = c(5, 5, 4, 2) + 0.1)
#     
#     plot(pos/scale, xpehh.data[, 3], pch = pch, col = col_chr, xlab = paste("Position", unit), 
#          ylab = expression(italic(XPEHH)), cex.lab = cex.lab, main = main, cex.main = cex.main, cex.axis = cex.axis)
#     
#     abline(h = c(-ylim.scan, ylim.scan), lty = 2)
#     dev.off()
...
#            xlab = paste("Position", unit), ylab = expression(-log[10] ~ "(" * italic(p) * "-value)"), cex.lab = cex.lab, 
